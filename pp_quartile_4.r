...
poorlyPred = which(abs(newResiduals) > quantile(abs(newResiduals))[4])
...
poorlypredictedq4ROC = roc(curveResponse, impForest)
plot.roc(poorlypredictedq4ROC)
save(poorlypredictedq4ROC, file = "poorlypredictedq4ROC.RData" )
